...
impl Cylinder {
    ...
    fn combustion_frequency(&self) -> f32 {
        match self.strokes {
    ...
    /// Sharp combustion pulse envelope
    ...
    pub fn next_sample(&mut self) -> f32 {
        let fire_freq = self.combustion_frequency();
